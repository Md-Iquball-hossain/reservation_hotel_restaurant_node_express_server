...
class hotelRestaurantController extends abstract_controller_1.default {
    constructor() {
        ...
        this.loginRestaurant = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.loginValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.Service.loginRestaurant(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        // get All Restaurant
        this.getAllRestaurant = this.asyncWrapper.wrap({ querySchema: this.Validator.getAllRestaurantQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.Service.getAllRestaurant(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
    }
}
