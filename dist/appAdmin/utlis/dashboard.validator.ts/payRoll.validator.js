...
class PayRollValidator {
    constructor() {
        this.CreatePayrollValidator = joi_1.default.object({
            ...
            attendance_days: joi_1.default.number().required(),
            deduction_amount: joi_1.default.number().optional(),
            deduction_reason: joi_1.default.string().allow("").optional(),
