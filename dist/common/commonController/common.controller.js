...
class CommonController extends common_abstract_controller_1.default {
    constructor() {
        ...
        // send email otp
        this.sendEmailOtpController = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.commonService.sendOtpToEmailService(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
        // match email otp
        this.matchEmailOtpController = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
