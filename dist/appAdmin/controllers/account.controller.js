...
class AccountController extends abstract_controller_1.default {
    constructor() {
        ...
        // Update Account
        this.updateAccount = this.asyncWrapper.wrap({ bodySchema: this.accountValidator.updateAccountValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.accountService.updateAccount(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        // balance transfer
        this.balanceTransfer = this.asyncWrapper.wrap({ bodySchema: this.accountValidator.balanceTransferValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.accountService.balanceTransfer(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
    }
}
