    ...
    createHallAmenities(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { data } = yield settingModel.getAllHallAmenities({ name, description, hotel_id });
                if (data.length) {
                    return {
                        success: false,
                ...
                const res = yield model.createHallAmenities({
                    hotel_id,
                    name,
                    description
                });
    ...
    updateHallAmenities(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const res = yield model.updateHallAmenities(parseInt(id), {
                    hotel_id,
    ...
    deleteHallAmenities(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                const { id } = req.params;
                const model = this.Model.settingModel(trx);
                const res = yield model.deleteHallAmenities(parseInt(id));
                if (res === 1) {
                    return {
                        success: true,
                        code: this.StatusCode.HTTP_OK,
