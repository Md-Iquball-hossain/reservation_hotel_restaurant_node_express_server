...
class RoomSettingController extends abstract_controller_1.default {
    constructor() {
        ...
        this.getAllRoomAmenities = this.asyncWrapper.wrap({ querySchema: this.settingValidator.getAllRoomAmenitiesQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.deleteRoomAmenities = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
