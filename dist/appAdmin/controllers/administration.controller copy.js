...
class AdministrationController extends abstract_controller_1.default {
    constructor() {
        ...
        this.createPermissionGroup = this.asyncWrapper.wrap({ bodySchema: this.administratorValidator.createPermissionGroupValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.administrationService.createPermissionGroup(req), { code } = _a, data = __rest(_a, ["code"]);
            res.status(code).json(data);
        }));
        // get permission group
        this.getPermissionGroup = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.administrationService.getPermissionGroup(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        // create permission
        this.createPermission = this.asyncWrapper.wrap({ bodySchema: this.administratorValidator.createPermissionValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getAllPermission = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.administrationService.getAllPermission(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
        // create role
        this.createRole = this.asyncWrapper.wrap({ bodySchema: this.administratorValidator.createRolePermissionValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.administrationService.createRole(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        // get role
        this.getRole = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _f = yield this.administrationService.getRole(req), { code } = _f, data = __rest(_f, ["code"]);
            res.status(code).json(data);
        }));
        // get single role
        this.getSingleRole = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _g = yield this.administrationService.getSingleRole(req), { code } = _g, data = __rest(_g, ["code"]);
            res.status(code).json(data);
        }));
        // update single role
        this.updateSingleRole = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _h = yield this.administrationService.updateSingleRole(req), { code } = _h, data = __rest(_h, ["code"]);
            res.status(code).json(data);
        }));
        // get admins role
        this.getAdminRole = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.administrationService.getAdminRole(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
        // create admin
        this.createAdmin = this.asyncWrapper.wrap({ bodySchema: this.administratorValidator.createAdminValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.administrationService.createAdmin(req), { code } = _k, data = __rest(_k, ["code"]);
            if (data.success) {
                res.status(code).json(data);
            }
            else {
        ...
        this.getAllAdmin = this.asyncWrapper.wrap({ querySchema: this.administratorValidator.getAllAdminQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _l = yield this.administrationService.getAllAdmin(req), { code } = _l, data = __rest(_l, ["code"]);
            res.status(code).json(data);
        }));
    }
}
exports.default = AdministrationController;
//# sourceMappingURL=administration.controller%20copy.js.map