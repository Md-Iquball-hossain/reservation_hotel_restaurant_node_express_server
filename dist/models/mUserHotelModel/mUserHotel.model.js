...
class MHotelUserModel extends schema_1.default {
    constructor(db) {
        super();
        this.db = db;
    }
    ...
    // get all hotel user
    getAllHotelUser(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const { from_date, to_date, name, status, limit, skip, city, group } = payload;
            ...
            const data = yield dtbs
                .withSchema(this.RESERVATION_SCHEMA)
                .select("id", "name", "city", "email", "status", "group", "created_at")
                .where(function () {
    ...
    //   get single hotel user
    getSingleHotelUser(payload) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = MHotelUserModel;
//# sourceMappingURL=mUserHotel.model.js.map