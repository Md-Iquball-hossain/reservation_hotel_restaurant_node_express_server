...
class HallBookingModel extends schema_1.default {
    ...
    getAllHallBookingByHallId(hotel_id, name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAllHallBooking(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield dtbs
                .withSchema(this.RESERVATION_SCHEMA)
                .select("hbv.id", "hbv.booking_no", "hbv.user_id", "hbv.name as client_name", "hbv.email as client_mail", "hbcio.id as hall_check_in", "hbv.event_date", "hbv.start_time", "hbv.end_time", "hbv.number_of_hours", "hbv.total_occupancy", "hbv.extra_charge", "hbv.grand_total", "hbv.pay_status", "hbv.due", "hbv.reserved_hall", "hbv.booking_status", "hbv.booking_date", "hbv.hall_booking_inv_id", "hbv.created_by_id", "hbv.created_by_name", "hbv.check_in_out_status")
    ...
    getSingleHallBooking(id, hotel_id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAllHallBookingCheckIn(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield dtbs
                .select("hbco.id", "u.name as name", "u.email as email", "b.id as booking_id", "b.booking_no", "hbco.check_in", "hbco.check_out", "hbco.event_date", "hbco.status", "hbco.created_at")
                .withSchema(this.RESERVATION_SCHEMA)
    ...
    getSingleHallBookingCheckIn(id, hotel_id) {
        return __awaiter(this, void 0, void 0, function* () {
