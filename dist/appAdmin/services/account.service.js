...
class AccountService extends abstract_service_1.default {
    ...
    createAccount(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                // insert account
                const res = yield model.createAccount(Object.assign(Object.assign({}, rest), { last_balance: opening_balance, hotel_id, created_by: id }));
    ...
    updateAccount(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const model = this.Model.accountModel();
            const account = yield model.upadateSingleAccount(Object.assign(Object.assign({}, rest), { hotel_id,
                last_balance }), { hotel_id, id });
            return {
                success: true,
                code: this.StatusCode.HTTP_SUCCESSFUL,
