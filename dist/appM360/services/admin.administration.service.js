...
class AdministrationService extends abstract_service_1.default {
    ...
    createAdmin(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userAdminModel = this.Model.userAdminModel();
            const check = yield userAdminModel.getAdminByEmail(req.body.email);
            if (check.length) {
                return {
                    success: false,
            ...
            const res = yield userAdminModel.insertUserAdmin(rest);
            if (res.length) {
                return {
                    success: true,
    ...
    getAllAdmin(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const userAdminModel = this.Model.userAdminModel();
            const res = yield userAdminModel.getAllAdmin();
            return {
                success: true,
                code: this.StatusCode.HTTP_SUCCESSFUL,
                data: res,
    ...
    createPermissionGroup(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.admin;
            const rolePermissionModel = this.Model.rolePermissionModel();
            const res = yield rolePermissionModel.rolePermissionGroup(Object.assign(Object.assign({}, req.body), { createdBy: id }));
            if (res.length) {
                return {
                    success: true,
                    code: this.StatusCode.HTTP_SUCCESSFUL,
    ...
    getPermissionGroup(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.admin;
            const rolePermissionModel = this.Model.rolePermissionModel();
            const data = yield rolePermissionModel.getRolePermissionGroup();
            return {
                success: true,
                code: this.StatusCode.HTTP_SUCCESSFUL,
                data,
    ...
    createPermission(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.admin;
            const { permissionGroupId, name } = req.body;
            const rolePermissionModel = this.Model.rolePermissionModel();
            const res = yield rolePermissionModel.createPermission({
                permissionGroupId,
                name,
                createdBy: id,
            });
    ...
    getAllPermission(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const rolePermissionModel = this.Model.rolePermissionModel();
            const data = yield rolePermissionModel.getAllPermission();
            const groupedPermissions = {};
            data.forEach((entry) => {
                const permissionGroupId = entry.permissionGroupId;
                const permission = {
    ...
    createRole(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { id } = req.admin;
                const rolePermissionModel = this.Model.rolePermissionModel(trx);
                // check role
                const checkRole = yield rolePermissionModel.getRoleByName(role_name);
                if (checkRole.length) {
                    return {
                        success: false,
                        code: this.StatusCode.HTTP_BAD_REQUEST,
                ...
                const res = yield rolePermissionModel.createRole({
                    role_name,
                });
                console.log({ res });
                // permissions
                ...
                const rolePermissionRes = yield rolePermissionModel.createRolePermission(permissionObj);
    ...
    getRole(Req) {
        return __awaiter(this, void 0, void 0, function* () {
            const rolePermissionModel = this.Model.rolePermissionModel();
            const data = yield rolePermissionModel.getRole();
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
                data,
    ...
    getSingleRole(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const rolePermissionModel = this.Model.rolePermissionModel();
            const originalData = yield rolePermissionModel.getSingleRole(parseInt(id));
    ...
    updateSingleRole(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                const rolePermissionModel = this.Model.rolePermissionModel(trx);
                if (role_name) {
                    yield rolePermissionModel.updateSingleRole(parseInt(role_id), {
                        name: role_name,
                    });
                }
                if (oldPermission.length) {
                    yield Promise.all(oldPermission.map((item) => __awaiter(this, void 0, void 0, function* () {
                        yield rolePermissionModel.deleteRolePermission(item.permission_id, item.permissionType, parseInt(role_id));
                    })));
                }
                if (newPermission.length) {
                    ...
                    yield rolePermissionModel.createRolePermission(body);
                }
                return {
                    success: true,
                    code: this.StatusCode.HTTP_SUCCESSFUL,
    ...
    getAdminRole(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rolePermissionModel = this.Model.rolePermissionModel();
            const res = yield rolePermissionModel.getAdminRolePermission(admin_id);
...
//# sourceMappingURL=admin.administration.service.js.map