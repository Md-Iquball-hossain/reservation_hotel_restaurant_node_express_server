...
const roomSetting_controller_1 = __importDefault(require("../controllers/roomSetting.controller"));
class RoomSettingRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.roomSettingController = new roomSetting_controller_1.default();
        this.callRouter();
    }
    callRouter() {
        //=================== Room Type Router ======================//
...
//# sourceMappingURL=roomSetting.router.js.map